...
#Akame
cl = LINETCR.LINE()
cl.login(token="EqawMSSa3nhQAEZ3avQ0.ejTDx7s/c9QLD+7HIAvI4a.MCCS1pjL94XtIpEmgqeBTyWJYPJ42QZ0GbjiOhNsTdE=")
cl.loginResult()

#Mine
ki = LINETCR.LINE()
ki.login(token="EqMCbRdsjYZyDqEsvbZ5.UgSpf0rCBg88YDiUxYKUXq.4yTYF8YUpLWGLHOiZeaZ8YEQPDQRItzZBPhGPR7uRmo=")
ki.loginResult()
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Smid,"u109b5d5fb4be0bdaa577fee189a562e0","ub86b0f17445c6c6f3cc9d22e5f292ec5"]
admin=["ua86fd1b861c39013293f8f76b1514e26",mid]
staff=[]
...
#--------------NOTIFIED_INVITE_INTO_GROUP----------------
        if op.type == 13:
		  ...
		  cl.sendText(op.param1,"Yeee~~\nTerimakasih udah  inpit saya ke grup kalian~~")        
...
#================================================================================
         ...
         #----------------Fungsi Join Group Start-----------------------#
			...
			ks.sendText(msg.to,"Aku datang kak ^-^")
                        ...
                        time.sleep(0.2)
			ku.sendText(msg.to,"Keadilan harus dutegakkan!")
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Apaan woy?")
                ki.sendText(msg.to,"Berisik tau!")
                ki.sendText(msg.to,"Eh, gua sama aja deng 􀜁􀅔Har Har􏿿")
#---------------------------------------------
#------------------MASTER NAGA--------------------------------BUATANKU------------
            if msg.text.lower() in ["HAI","HAY","Hai","Hay","hai","hay","HI","Hi","hi"]:
				rts = ("Hai juga sayangku", "Hai juga suami masa depanku","Ada apa sayangku?","Sayang, kamu manggil aku?","Hai juga kak ","Halo kak,","Ada apa kak,")
