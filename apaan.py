...
#Akame
cl = LINETCR.LINE()
cl.login(token="EqXtX5sbpcx20gQ7e9u0.ejTDx7s/c9QLD+7HIAvI4a.zJEeiDS6UVpiivgIwYUOKwZqJamMOQUfpq/3o7srsRk=")
cl.loginResult()
...
#------------------B--U--A--T--A--N--K--U--------------------------------
            ...
            if msg.text.lower() in ["ALO","Alo","alo","HALO","Halo","halo"]:
            	contact = cl.getContact(msg.from_)
                cName = contact.displayName
